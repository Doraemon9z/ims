<template>
  <div>
    <div style="margin-bottom: 5px;">
      ...
      <el-select v-model="storage" placeholder="请选择供应商" style="margin-left: 5px;">
        <el-option
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="storage" label="供应商名" width="180" :formatter="formatStorage">
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        ...
        <el-form-item label="供应商名" prop="storage">
          <el-col :span="20">
            <el-select v-model="form.storage" placeholder="请选择供应商" style="margin-left: 5px;">
              <el-option
                  v-for="item in storageData"
                  :key="item.id"
                  :label="item.name"
    ...
    <el-button type="primary" @click="doInGoods1">确 定</el-button>
  </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    del(id) {
      ...
      this.$axios.get(this.$httpUrl + '/ims/goods/del?id=' + id).then(res => res.data).then(res => {
        console.log(res)
        if (res.code == 200) {
    ...
    doSave() {
      this.$axios.post(this.$httpUrl + '/ims/goods/save', this.form).then(res => res.data).then(res => {
        console.log(res)
        if (res.code == 200) {
    ...
    doMod() {
      this.$axios.post(this.$httpUrl + '/ims/goods/update', this.form).then(res => res.data).then(res => {
        console.log(res)
        if (res.code == 200) {
    ...
    doInGoods() {
      this.$axios.post(this.$httpUrl + '/ims/record/save', this.form1).then(res => res.data).then(res => {
        console.log(res)
        if (res.code == 200) {
    ...
    loadPost() {
      this.$axios.post(this.$httpUrl + '/ims/goods/listPage', {
    ...
    loadStorage() {
      this.$axios.get(this.$httpUrl + '/ims/storage/list').then(res => res.data).then(res => {
        console.log(res)
        if (res.code == 200) {
    ...
    loadGoodstype() {
      this.$axios.get(this.$httpUrl + '/ims/goodstype/list').then(res => res.data).then(res => {
        console.log(res)
        if (res.code == 200) {
